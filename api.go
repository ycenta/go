...
func main() {
	...
	r.HandleFunc("/payment", payment.CreatePayment(db))
	r.HandleFunc("/payment/{id:[0-9]+}", payment.GetPaymentById(db))
	r.HandleFunc("/payment/{id}/update", payment.UpdatePayment(db))
	r.HandleFunc("/payment/{id}/delete", payment.DeletePayment(db))
	r.HandleFunc("/payments", payment.GetAllPayments(db))
